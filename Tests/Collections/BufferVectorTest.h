...
static MunitResult testBuffVecCreation(const MunitParameter params[], void *data) {
    ...
    u32Vector *u32Vec = NEW_VECTOR_OF(12, uint32_t, u32, 1, 2, 3, 4, 5);
    assert_uint32(u32Vec->size, ==, 5);
    assert_uint32(u32Vec->capacity, ==, 12);

    i8Vector *i8Vec = VECTOR_OF(int8_t, i8, 1, -2, -110, 4, 5);
    ...
    cStrVector *strVec = VECTOR_OF(char*, cStr, "aaa", "bbb", "ccc");
...
static MunitResult testBuffVecAdd(const MunitParameter params[], void *data) {
    cStrVector *strVec = NEW_VECTOR_4(char*, cStr);
...
static MunitResult testBuffVecUnion(const MunitParameter params[], void *data) {
    ...
    cStrVector *strVec3 = cStrVecUnion(NEW_VECTOR_16(char*, cStr), strVec2);
    ...
    assert_null(cStrVecUnion(NEW_VECTOR_16(char*, cStr), NULL));
    return MUNIT_OK;
}
...
static MunitResult testNaturalSortTest(const MunitParameter params[], void *data) {
    ...
    strVector *strVec = strVecFromArray(NEW_VECTOR_64(str), strArray, ARRAY_SIZE(strArray));
    strVecSort(strVec);
